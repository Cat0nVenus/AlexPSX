...
static const char *funny_messages[][2] = {
	{"ALEXFNF BY CATONVENUS", "UWU"},
	{"TAKE A SIP", "ITS YOUR CUM SHAKE"},
	{"GOD IM", "SO ALONE"},
	{"WHAT THE HELL", "CUM FUNI"},
	{"LIKE RADAR", "BUT COOLER"},
	{"RIP STIXX", "THEY DIED"},
	{"RADAR APPROVED", "JUNE TWENTYONE"},
	{"YOU ARE A BOTTOM", "NO IM NOT"},
	{"GOD IM SO ALONE", "I MEAN CUM FUNI"},
	{"NINJA", "LOVES THE VBUCKS"},
	{"CUDDLES XD", "SAJDKSADLSA"},
	{"PISS IN MY MOUTH", "PLEASE"},
	{"JUSTICE FOR RADAR", "RADAR WARRIOR"},
	{"uwu", "owo"},
	{"TWITTER", "FOREVER"},
	{"FOURTEEN", "BOTTOM IN BIO"},
	{"NUZZLES YOU", "UWU"},
	{"MOST CONTROVERSIAL POST", "ON FURRYIRL"},
	{"OMG CATS", "SQUEEEE"},
	{"I HAVE A PISS KINK", "I LOVE PISS"},
	{"IM NOT CUTE", "IM FOURTEEN"},
	{"MARK THE FOX", "BURN IN HELL"},
	{"BLUE FOLF APPROVED", "WIN"},
	{"FJKSJDSKALJDSKJSADH", "I SAID IM NOT CUTE"},
	{"LOADING SCREEN ART", "BY CHARA"},
	{"ALEX BY IVORY", "SUCK HER OFF"},
	{"ALEX IS CUTE FEMBOY UWU", "DIE DIE DIE"},
	{"NEXT IN LINE", "CRIMSON"},
	{"FURRYTWT", "COME ON"},
	{"STUPIDGAYFOXMAN", "GREAT USERNAME"},
	{"GET ME TO STOP", "TRY"},
	{"ALEX SEX VIDEOS", "THATS UNRULY"},
	{"CUTE FOXXO", "FOREVER"},
		...
		case MenuPage_Opening:
		{
			...
			else
			{
				...
				//Fallthrough
					case 2:
					case 1:
						menu.font_bold.draw(&menu.font_bold, "CATONVENUS",   SCREEN_WIDTH2, SCREEN_HEIGHT2 - 32, FontAlign_Center);
						menu.font_bold.draw(&menu.font_bold, "IVORYASF", SCREEN_WIDTH2, SCREEN_HEIGHT2 - 16, FontAlign_Center);
						menu.font_bold.draw(&menu.font_bold, "CHARA",   SCREEN_WIDTH2, SCREEN_HEIGHT2,      FontAlign_Center);
						menu.font_bold.draw(&menu.font_bold, "INITIALS NG",      SCREEN_WIDTH2, SCREEN_HEIGHT2 + 16, FontAlign_Center);
						break;
					
					case 7:
						menu.font_bold.draw(&menu.font_bold, "TWITTER",    SCREEN_WIDTH2, SCREEN_HEIGHT2 - 32, FontAlign_Center);
						Gfx_BlitTex(&menu.tex_ng, &src_ng, (SCREEN_WIDTH - 128) >> 1, SCREEN_HEIGHT2 - 16);
				//Fallthrough
					case 6:
					case 5:
						menu.font_bold.draw(&menu.font_bold, "INSPIRED BY EVENTS", SCREEN_WIDTH2, SCREEN_HEIGHT2 - 64, FontAlign_Center);
						menu.font_bold.draw(&menu.font_bold, "FROM",           SCREEN_WIDTH2, SCREEN_HEIGHT2 - 48, FontAlign_Center);
						break;
				...
				//Fallthrough
					...
					case 15:
						menu.font_bold.draw(&menu.font_bold, "FUNK", SCREEN_WIDTH2, SCREEN_HEIGHT2 + 8, FontAlign_Center);
				//Fallthrough
					case 14:
						menu.font_bold.draw(&menu.font_bold, "THE ARTIC", SCREEN_WIDTH2, SCREEN_HEIGHT2 - 8, FontAlign_Center);
				//Fallthrough
					case 13:
						menu.font_bold.draw(&menu.font_bold, "ALEX", SCREEN_WIDTH2, SCREEN_HEIGHT2 - 24, FontAlign_Center);
						break;
				}
				break;
			}
	...
	//Fallthrough
		...
		case MenuPage_Story:
		{
			static const struct
			{
				...
				{"2", StageId_2_1, "THE REAL RADAR RUBBISH", {"RUBISH", "IMPOSTOR", "JUST SUNG THIS"}},
				{"3", StageId_3_1, "FORTNITE AT FREDDYS", {"FIVE WINS AT FORTNITE", "SNIPER", "IM NOT NINJA"}},
				{"4", StageId_4_1, "WILD SIDE", {"BEASTMAN", "UNLEASHED", "STORY OF UNDERTALE"}},
		...
		case MenuPage_Freeplay:
		{
			static const struct
			{
				...
				{StageId_1_1, 0xFF9271FD, "FLAMINGO"},
				{StageId_1_2, 0xFF9271FD, "BIG CHUNGUS"},
				{StageId_1_3, 0xFF9271FD, "MEGALOVANIA"},
				{StageId_2_1, 0xFF223344, "RUBISH"},
				{StageId_2_2, 0xFF223344, "IMPOSTOR"},
				{StageId_2_3, 0xFF223344, "JUST SUNG THIS"},
				{StageId_3_1, 0xFF941653, "FIVE WINS AT FORTNITE"},
				{StageId_3_2, 0xFF941653, "SNIPER"},
				{StageId_3_3, 0xFF941653, "IM NOT NINJA"},
				{StageId_4_1, 0xFFFC96D7, "BEASTMAN"},
				{StageId_4_2, 0xFFFC96D7, "UNLEASHED"},
				{StageId_4_3, 0xFFFC96D7, "STORY OF UNDERTALE"},
				{StageId_5_1, 0xFFA0D1FF, "DIE ANYWHERE ELSE"},
				{StageId_5_2, 0xFFA0D1FF, "WEIRD AUTUMN"},
				{StageId_5_3, 0xFFA0D1FF, "PUMPKIN HEAD GUY"},
				{StageId_6_1, 0xFFFF78BF, "LULLABY"},
				{StageId_6_2, 0xFFFF78BF, "THE LEGEND"},
				{StageId_6_3, 0xFFFF78BF, "CASTLE TOWN"},
